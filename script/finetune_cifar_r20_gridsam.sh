...
python train_sam.py --save_path ./output/cifar100/finetune/r20/ --data_path ./dataset/ --dataset cifar100 --lr 0.01 --clip_lr 0.01 --opt_type GridSAM_SGD --gain_budget 1e-2 --kappa_mode global --m_floor_frac 0.0 --network qsampreresnet20 --pretrained ./pretrained/cifar100_resnet.pth --qw 2.0 --qa 2.0 --quan_type LIQ_wn_qsam --experiment_id 01 --seed 1 --gpu 0
